...
export function Pricing() {
  ...
  const faqItems = [
    { q: 'Do credits expire?', a: 'Paid credits never expire. Free credits reset on the 1st of every month.' },
    {
      ...
      a: "1 credit = 1 AI action. For replies, that's 3 drafts at once. For meetings, it's 1 summary or 1 action-item extraction."
    },
    {
    ...
    },
    {
      ...
      a: 'The web dashboard works on any device. The Gmail extension requires Chrome on desktop.'
    },
  ];
      ...
      <main className="pricing-main">
        <div className="pricing-header">
          ...
          <p className="pricing-sub">
            Everyone gets 5 free credits every month for replies,
            meeting summaries, and action item extraction.
            Buy more when you need them &mdash; they never expire.
          </p>

          <div className="currency-toggle-container">
            <span className={`currency-label ${currency === 'NGN' ? 'active' : ''}`}>
              NGN (Local)
            </span>
            <button
            ...
            <span className={`currency-label ${currency === 'USD' ? 'active' : ''}`}>
              USD (Global)
            </span>
          </div>
          ...
          {credits && (
            <div className="current-credits">
              You currently have{' '}
              {credits.free > 0
                ? `${credits.free} free ${credits.free === 1 ? 'reply' : 'replies'}`
                : '0 free replies'}{' '}
              remaining
            ...
            >
              ...
              <div className="pricing-card-header">
                ...
                <div className="pricing-cost-per">
                  {currency === 'NGN'
                    ? `${pack.pricePerReply} per reply`
                    : `${pack.pricePerReplyUSD} per reply`}
                </div>
              </div>
              <ul className="pricing-features">
                <li className="pricing-feature"><Check /> {pack.credits} reply generations</li>
                <li className="pricing-feature"><Check /> {pack.credits * 3} total drafts</li>
                <li className="pricing-feature"><Check /> All 5 tone options</li>
                <li className="pricing-feature"><Check /> AI meeting summaries</li>
                <li className="pricing-feature"><Check /> Action item extraction</li>
                <li className="pricing-feature"><Check /> Never expires</li>
              </ul>
                ...
                {user ? (
                  <button
                    ...
                    style={{
                      ...
                      background: pack.popular ? '#6366f1' : '#23283a',
                  ...
                  <a href="/app" className="pricing-signin-cta">
                    Sign in to purchase
                  </a>
                )}
              </div>
